  ...
  let matchingProduct;
    ...
    products.forEach((product) => {
      if(product.id === productId){
        matchingProduct = product;  //now we have access to image,name etc
      }
    });
...
// One class is more specific type of other class
// Inheritence let us reuse code between classes
class Clothing extends Product {
  sizeChartLink;

  constructor(productDetails) {
    super(productDetails); // calls constructor of the parent class
...
// callback() a function to run in future